...
En este caso, Sera necesario instalar RStudio para realizar los ejercicios de manera comoda, por lo que, para instalar RStudio para los distintios Sistemas Operativos podemos hacerlo desde la liga principal, o para evitar buscar podemos usar la liga que más nos convenga de la siguiente tabla.
